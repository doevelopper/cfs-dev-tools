#include <cfs/dev/tools/DummyTest.hpp>

using namespace cfs::dev::tools::test;

log4cxx::LoggerPtr DummyTest::logger = log4cxx::Logger::getLogger(std::string("cfs.dev.tools.DummyTest"));
...
{
    LOG4CXX_TRACE(logger , __LOG4CXX_FUNC__);
    cfs::dev::toools::Dummy d{"Hello", "World"};
...
{
   LOG4CXX_TRACE(logger , __LOG4CXX_FUNC__);
   cfs::dev::tools::Dummy d{"Hello", "World"};
